...
function onTick()
    ...
    if moduleID==3 then
        output.setBool(1,button(25,21,5,5,false))--up
        output.setBool(2,button(25,27,5,5,false))--down

        if button(0,20,13,22,true) then
          switch=not switch 
          touch.flags=true
        end
...
function moduleUnit()
    ...
    if switch then
        ...
        screen.drawRectF(24,20,7,13)

        screen.setColor(50, 50, 50)
        screen.drawRectF(25,21,5,5)
        screen.drawRectF(25,27,5,5)

        screen.setColor(255, 255, 255)
        screen.drawText(26,21,"+")
        screen.drawText(26,27,"-")
